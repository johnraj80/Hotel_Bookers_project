...
import { fetchRegisteredHotels } from '../../features/admin/adminSlice';

const RegisteredHotels = () => {
  const dispatch = useDispatch();
  const registeredHotels = useSelector((state) => state.admin.registeredHotels);

  useEffect(() => {
    dispatch(fetchRegisteredHotels());
  }, [dispatch]);
